...
import whatsappIntegration from "./routes/whatsapp-integration";
...
app.use(
  "*",
  cors({
    origin: (origin) => origin || "*", // Allow all origins for mobile app support
...
app.route("/whatsapp-integration", whatsappIntegration);
app.route("/chat", chat);
