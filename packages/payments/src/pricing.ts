...
export const PRICING_USD: Record<PlanType, PlanAmounts> = {
  LITE:       { perTermCost: 240, monthlyEstimate: 40,  annualPrice: 480,  foundingAnnualPrice: 360,  studentLimit: 300 },
  GROWTH:     { perTermCost: 225, monthlyEstimate: 75,  annualPrice: 900,  foundingAnnualPrice: 675,  studentLimit: 800 },
  ENTERPRISE: { perTermCost: 360, monthlyEstimate: 120, annualPrice: 1440, foundingAnnualPrice: 1080, studentLimit: 0 },
};

/** ZAR pricing (~20x conversion factor) - monthly recurring */
export const PRICING_ZAR: Record<PlanType, PlanAmounts> = {
  LITE:       { perTermCost: 2400, monthlyEstimate: 800,  annualPrice: 9600,  foundingAnnualPrice: 7200,  studentLimit: 300 },
  GROWTH:     { perTermCost: 4500, monthlyEstimate: 1500, annualPrice: 18000, foundingAnnualPrice: 13500, studentLimit: 800 },
  ENTERPRISE: { perTermCost: 7200, monthlyEstimate: 2400, annualPrice: 28800, foundingAnnualPrice: 21600, studentLimit: 0 },
};

/** ZiG pricing (~13.5x conversion factor) - monthly recurring */
export const PRICING_ZIG: Record<PlanType, PlanAmounts> = {
  LITE:       { perTermCost: 1620, monthlyEstimate: 540,  annualPrice: 6480,  foundingAnnualPrice: 4860,  studentLimit: 300 },
  GROWTH:     { perTermCost: 3037, monthlyEstimate: 1012, annualPrice: 12150, foundingAnnualPrice: 9112,  studentLimit: 800 },
  ENTERPRISE: { perTermCost: 4860, monthlyEstimate: 1620, annualPrice: 19440, foundingAnnualPrice: 14580, studentLimit: 0 },
};
